...
namespace DungeonExplorer
{
    public class Tests
    {
        public static void RunTests()
        {
            ...
            Room testRoom = new Room("A dark, rat infested room", new List<Item> { new Weapon("Sharp Stick", 5) }, null, false);
            ...
            testPlayer.PickUpItem(new Weapon("Sharp Stick", 5));
            ...
            testPlayer.PickUpItem(new Weapon("Sharper Stick", 5));
            ...
            testRoom.RemoveItem(testRoom.GetItems().First(i => i.Name == "Sharp Stick"));
